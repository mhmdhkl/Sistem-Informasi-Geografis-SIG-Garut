        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-2xl font-bold mb-6">Formulir Impor</h3>
                    ...
                    <form action="{{ route('layers.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="space-y-4">
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="deskripsi" id="deskripsi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('deskripsi') }}" placeholder="Contoh: Layer Poligon Batas Desa se-Kabupaten Garut">
                            </div>
                            <div>
                                <label for="geojson_file" class="block font-medium text-sm text-gray-700">File GeoJSON (.geojson)</label>
                                <input type="file" name="geojson_file" id="geojson_file" class="mt-1 block w-full" required accept=".geojson,application/json">
                            </div>
                        </div>
